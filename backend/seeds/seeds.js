exports.seed = function (knex) {
  ...
  return (
    knex("users")
      .insert([
        {
          ...
          nickname: "Keanu",
          picture:
            "https://www.nme.com/wp-content/uploads/2020/07/cyberpunk2077-credit-cdprojektred@2000x1270-696x442.jpg",
          email: "notanemail@email.com",
          bio: "Professional Gamer, 16 inch laptop screen",
          type: "admin",
        },
        {
          username: "Sam",
          password: "placeholder",
          nickname: "Big Sam11111",
          picture:
            "https://www.nme.com/wp-content/uploads/2020/07/cyberpunk2077-credit-cdprojektred@2000x1270-696x442.jpg",
          email: "notanemail2@email.com",
          bio: "Professional Gamer, 16 inch laptop screen",
          type: "teacher",
        },
        {
          username: "student1",
          password: "placeholder",
          nickname: "Keanu Steve",
          picture:
            "https://www.nme.com/wp-content/uploads/2020/07/cyberpunk2077-credit-cdprojektred@2000x1270-696x442.jpg",
          email: "notanemail3@email.com",
          bio: "Professional Gamer, 16 inch laptop screen",
          type: "student",
        },
        {
        ...
        return knex("institutions").insert([
          {
            name: "Xccelerate",
            picture:
              "https://i.imgur.com/m01Ytyw.pnghttps://i.imgur.com/m01Ytyw.png",
            overview:
      ...
      .then(function () {
        return knex("courses").insert([
          ...
          },
          {
            ...
            picture: "https://i.imgur.com/x2gEw7U.jpg",
            url:
          ...
          },
          {
            ...
            picture: "https://i.imgur.com/cbiYRH0.jpg",
          ...
          },
          {
            ...
            picture: "https://i.imgur.com/uNdnFlc.jpg",
            url:
          ...
          },
          {
            ...
            picture: "https://i.imgur.com/BRPc2Rl.jpg",
          ...
          },
          {
            ...
            picture: "https://i.imgur.com/sJiXPNO.jpg",
            url:
          ...
          },
          {
            ...
            picture: "https://i.imgur.com/SsgQZBz.jpg",
            url:
          ...
          },
          {
            ...
            picture: "https://i.imgur.com/agY2di7.png",
            url:
              "https://flatironschool.com/career-courses/cybersecurity-analytics",
            institutionsID: 3,
          },
          {
            ...
            picture: "https://i.imgur.com/6zZ6a53.png",
            url:
              "https://flatironschool.com/career-courses/cybersecurity-engineering",
            institutionsID: 3,
          },
          {
            name: "Data Science",
            ...
            picture: "https://i.imgur.com/LQBqqby.png",
            url:
              "https://flatironschool.com/career-courses/data-science-bootcamp",
            institutionsID: 3,
          },
          {
            ...
            picture: "https://i.imgur.com/lSbv65X.png",
        ...
        return knex("questions").insert([
          {
            ...
            privacy: true,
            classpin: false,
            institutionpin: false,
            answered: false,
            usersID: 1,
            classesID: 1,
          },
          {
            title: "Help! I can't do the thing!",
            text: "Lorem Ipsum",
            votes: 10,
            privacy: true,
            classpin: false,
      ...
      // Admins Seeds
      .then(function () {
        return knex("admins").insert([{ usersID: 1, institutionsID: 1 }]);
      })
      ...
      // tags Seeds
      .then(function () {
        return knex("tags").insert([{ name: "question" }]);
      })
      // questionstags Seeds
      .then(function () {
